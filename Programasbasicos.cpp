...
using namespace std;
main(){
	int n=0,n1=0,n2=0,n3=0,n4=0,n5=0,dis=0,uni=0,de=0,cen=0,mi=0,x=0;
	float f=0,f1=0,f2=0;
	char res,res2;
	string txt;
	...
	cout<<"13. Crear Figuras Geometricas Básicas.: "<<endl;
	...
	break;
		...
		float saldo1;
			...
			switch(op){
				...
				case 3:
					cout<<"su saldo actual es: "<<saldo<<endl;break;
				case 4:	break;
					}
			cout<<endl<<"--------------------------------------------------------"<<endl;
